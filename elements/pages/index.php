      ...
      <div class="ws-12">
        <ul class="inline crow gutter up">
          ...
          <li class="ws-6">
            ...
            <p>Visit myurl.localhost/?compile to compile your PHP project into HTML. <a href="<?php echo $app->url?>?compile">Try it here</a>.
            </p>
            <div class="spacer half"></div>
          </li>
          <li class="ws-6">
          ...
          <li class="ws-6">
            <h2>Markup img's</h2>
            <p>Put a <?php echo htmlspecialchars('<img />')?> tag anywhere and a placeholder image will pop up, <a href="/modules/module/image">like so</a>.
            </p>
            <div class="spacer half"></div>
          </li>
          <li class="ws-6">
